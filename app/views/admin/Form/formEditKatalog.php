                    ...
                    <div class="container-form">
                        <form action="<?= BASEURL . 'Admin/editKatalog' ?>" method="POST" enctype='multipart/form-data'>
                            ...
                            <div class="terjual">
                                ...
                                <span>:</span>
                                <input name="sold" id="terjual" type="text" placeholder="Masukan terjual" value="<?= $data['catalog']['sold'] ?>" disabled>
                            </div>
                            <div class="Kategori">
                            ...
                            <div class="deskripsi">
                                ...
                                <span>:</span>
                                <textarea name="deskripsi_katalog" id="deskripsi" cols="30" rows="20" required><?= $data['catalog']['deskripsi_katalog'] ?></textarea>
                            </div>
