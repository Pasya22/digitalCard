        ...
        <div class=" container-penjelasan-produk">
            ...
            <div class="content">
                <div class="primary-box content-box">
                    ...
                    <div class="deskripsi">
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam iure autem sunt distinctio
                            aperiam accusantium voluptatem rerum voluptates atque eos numquam ex consequuntur
                            praesentium harum, quia itaque fuga quod nisi animi laudantium doloremque incidunt quis
                            ratione iste? Voluptate quo quidem, consequatur blanditiis consectetur, neque distinctio
                            labore omnis autem molestiae aliquid nihil porro nesciunt quae ullam possimus maxime, rem ut
                            ducimus! Eos aperiam ut repudiandae, delectus consequatur atque aspernatur corporis quisquam
                            sunt iusto alias maiores excepturi qui neque impedit culpa consequuntur. Officiis sint enim
                            cum nesciunt modi, voluptas placeat ab. Ea alias voluptas consectetur explicabo maiores,
                            magnam quae. Quam, id eveniet!</p>
                    </div>
                    <div class="button">
        ...
        <div class="container-penjelasan-produk">
            ...
            <div class="content">
                ...
                <div class="secondary-box content-box">
                    ...
                    <div class="deskripsi">
                        <?php
                        $str_produk = $data['katalog']['deskripsi_katalog'];
                        $str_produk_wrapped = str_replace("\n", "<br>\n", $str_produk);
                        ?>
                        <p><?php echo $str_produk_wrapped; ?></p>
                    </div>
                    <div class="button">
                        <button>Click Me</button>
                    </div>
